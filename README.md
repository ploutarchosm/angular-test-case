не обязательно выполнять все задания выполните те которые сделаете хорошо и комфортно.   

## Общие данные

Основные цвета - #43526, #8676b. Фон страницы - белый. Ссылки - #2d6fb1. Базовый размер шрифта - 14px;

Можно устнавливать любые необходимые npm-пакеты.
...
Вывести общий для всех страниц header. В нем разместить информацию о пользователе:
* текущие First Name, Last Name
* ссылка на профиль
* ссылка Logout (без функционала)
